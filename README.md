...
| members | Artifact Registry Reader, Writer and repoAdmin roles for Users/SAs. Key names must be readers and/or writers and/or repo admins | `map(list(string))` | `{}` | no |
